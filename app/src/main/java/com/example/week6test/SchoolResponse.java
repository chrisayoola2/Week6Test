...
public class SchoolResponse implements Parcelable {
         ...
         */
        public SchoolResponse(String dbn, String schoolName, String numOfSatTestTakers, String satCriticalReadingAvgScore, String satMathAvgScore, String satWritingAvgScore) {
            super();
            this.dbn = dbn;
